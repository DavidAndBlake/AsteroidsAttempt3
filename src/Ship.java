...
public class Ship implements ActionListener {
	private int[] leftSideShipXPoints = { 0, -16, -32, -16, -10, 0 };
	private int[] leftSideShipYPoints = { -31, 9, 21, 18, 14, 14 };
	private int[] rightSideShipXPoints = { 0, 10, 16, 32, 16, 0 };
	private int[] rightSideShipYPoints = { 14, 14, 18, 21, 9, -31 };
	private int[] canopyXPoints = { 7, 0, -7 };
	private int[] canopyYPoints = { 6, -9, 6 };
	public int shipXPos;
	public int shipYPos;
	private int deltaX;
	private int deltaY;
...
Ellipse2D.Double shipWreck = new Ellipse2D.Double(0 - shipWreckWidth/2,
					0 - shipWreckHeight/2, shipWreckWidth, shipWreckHeight);
